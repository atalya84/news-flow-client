			...
			<Grid item xs={7}>
				...
				{edit ? (
					...
					<div className="user-form">
						<TextInput icon={<AccountCircleIcon />} className='fields' title="Change your name" value={name} onChange={setName} isValueValid={nameValid.isValid} errorText={nameValid.errorText} />
						<TextInput icon={<AlternateEmailIcon />} className='fields' title="Change your Email" type="email" value={email} onChange={setEmail} isValueValid={emailValid.isValid} errorText={emailValid.errorText}/>
					</div>
					<LoadingButton
						sx={editButton}
